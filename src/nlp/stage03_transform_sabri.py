...
def run_transform(
    ...
    # =========================
    # NEW: Simple Classification
    # =========================
    category = "Other"

    if any(word in clean_text for word in ["ai", "machine", "learning", "neural"]):
        category = "AI / Machine Learning"
    elif any(word in clean_text for word in ["data", "analysis", "statistics"]):
        category = "Data Science"
    elif any(word in clean_text for word in ["network", "security"]):
    ...
    LOG.info("========================")
    LOG.info("STAGE 03f: Create and return DataFrame")
    LOG.info("========================")

    # Create a DataFrame with the extracted and derived fields
    ...
    LOG.info(f"Created DataFrame with {len(df)} row(s)")
    LOG.info("STAGE 03: TRANSFORM complete")
    LOG.info("========================")
